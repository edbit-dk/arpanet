...
return [
    ...
    [
        ...
        'password' => random_pass(),
        'org' => 'Tymshare Inc.',
        'location' => 'Cupertineo, CA',
        'welcome' =>  'TYMNET by Tymshare Inc.',
        'notes' => 'SYSADMIN: admin@tym.net',
        'os' => 'PDP-10 4.3BSD UNIX',
        'ip' => random_ip(),
        'network' => 1,
        'level_id' => 2,
        'created_at' => timestamp("1968-01-01 06:30:00", true)
    ],
    [
        'id' => 7,
        'user_id' => 1,
        ...
        'welcome' =>  'TELENET by Bolt Beranek & Newman',
    ...
    [
        ...
        'org' => 'United States Department of Energy (DOE)',
        'location' => 'USA',
        'welcome' =>  "All activity may be monitored and recorded!",
        'notes' => 'SYSADMIN: admin@energy.gov',
    ...
    [
        ...
        'location' => 'USA',
        'welcome' =>  "All activity may be monitored and recorded!",
        'notes' => 'SYSADMIN: admin@norad.mil',
        'os' => 'VAX/VMS UNIX',
        'ip' => random_ip(),
        'network' => 0,
        'level_id' => 6,
