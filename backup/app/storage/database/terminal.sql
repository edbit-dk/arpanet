...
--
-- Vært: localhost
-- Genereringstid: 23. 07 2024 kl. 23:41:29
...
CREATE TABLE `help` (
  ...
  `opt` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `params` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
--
-- Struktur-dump for tabellen `server_accounts`
--
...
--
-- Indeks for tabel `server_accounts`
--
...
--
-- Tilføj AUTO_INCREMENT i tabel `server_accounts`
--
ALTER TABLE `server_accounts`
  MODIFY `id` bigint UNSIGNED NOT NULL AUTO_INCREMENT;
